...
#to do: update so that the FE can be aligned to a specified point or skipped separate to PMF alignment
'''
surfaceTargetSet = [    ["CNT15", "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-COOH-30",  "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-COOH-3",  "cylinder",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-COO--10",  "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-COO--3",   "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-NH2-14",  "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-NH2-2",  "cylinder",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-NH3+-4",   "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-NH3+-2",  "cylinder",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-OH-14",   "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["CNT15-OH-4",   "cylinder", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["graphene",  "plane", alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["bi-graphene",  "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0], 
    ["tri-graphene",   "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["grapheneoxide",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["redgrapheneoxide",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["C-amorph-2",  "plane", alignPointEnergyDefault,0,7.5, 0] ,
    ["Fe2O3-001O",  "plane",alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["CdSeWurtzite2-10",   "plane",alignPointEnergyDefault,0, 25, 0] ,
    ["SiO2-Quartz",  "plane",alignPointEnergyDefault,0, 10, 0] ,
    ["SiO2-Amorphous",  "plane", alignPointEnergyDefault,0,10, 0] ,
    ["TiO2-rut-110",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["TiO2-rut-100",   "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["TiO2-ana-100",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["Ag111",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["Ag110",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0], 
    ["Ag100",   "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["Al-fixed",   "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["TiO2-ana-101",  "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 0] ,
    ["AuFCC100",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["AuFCC100UCD",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 0] ,
    ["AuFCC100-Ablate0",   "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 1] ,
    ["AuFCC100-Ablate5",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 1]  ,
    ["AuFCC100-Ablate25",   "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 1]  ,
    ["AuFCC100-Ablate50",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 1]  ,
    ["AuFCC100-Ablate75",  "plane",alignPointEnergyDefault,0, pmfAlignEnergyDefault, 1] ,
    ["AuFCC100-Ablate100",  "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault,1] ,
    ["GoldBrush", "plane", alignPointEnergyDefault,0,pmfAlignEnergyDefault, 1]
     ]
'''
...
for surfaceTarget in surfaceTargetSet:
    ...
    if args.forcerecalc == 0:
        feOutput = outputFolder+"/" +surfaceName+"_fev2.dat"
    ...
    if canSkip == 0:
        ...
        for r in rRange:
            ...
            if np.isfinite(freeEnergy):
                ...
                resList.append( [r,r-r0Start, r-r0Start, freeEnergy,electrostatic])
            else:
                lastInfPoint = r
                
        print("Starting water")
        rRangeWater =r0Start + np.arange(lastInfPoint-r0Start, 1.5,  0.025)        
        ...
        resArray = np.genfromtxt(outputFolder+"/" + surfaceName+"_fev2.dat",delimiter=",",skip_header=1)
    ...
    np.savetxt( outputFolder+"/" + surfaceName+"_fev2.dat", resArray, fmt='%2.7f',delimiter=",", header="r[nm],d[nm],daligned[nm],U(d)[kj/mol],V(d)[e/nm]")
